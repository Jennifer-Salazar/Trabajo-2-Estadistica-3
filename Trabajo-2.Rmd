...
\begin{array}{| c | c | c | c| c |}
\hline
Parametros&Estimación&s.e&Valor~T_0&Pr(>|t|)\\
\hline
\phi_1&0.20883541&0.06612159&3.1584&0.0018518\\
\phi_2&0.36294255&0.06772851&5.3588&2.459e-07\\
...
\beta_0&35.80275224&1.81258848&19.7523&<2.2e-16\\
\beta_1&0.13282184&0.03425616&3.8773&0.0001464\\
\beta_2&0.00070518&0.00017176&4.1056&6.033e-05\\
\delta_1&-3.35642614&0.95012883&-3.5326&0.0005190\\
\delta_2&4.92492708&1.09257560&4.5076&1.157e-05\\
\delta_3&11.62982569&1.23545763&9.4134&<2.2e-16\\
\delta_4&7.08753911&1.51287395&4.6848&5.397e-06\\
\delta_5&11.90175812&1.56332054&7.6131&1.305e-12\\
\delta_6&9.67442937&1.54905786&6.2454&2.803e-09\\
\delta_7&8.45115846&1.54688824&5.4633&1.485e-07\\
\delta_8&9.08567647&1.49364257&6.0829&6.573e-09\\
\delta_9&12.60700269&1.20682578&10.4464&<2.2e-16\\
\delta_{10}&10.73940310&1.06267664&10.1060&<2.2e-16\\
\delta_{11}&9.13567910&0.93967858&9.7221&<2.2e-16\\
\hline
\end{array}
$$
...
\begin{array}{| c | c | c | c| c |}
\hline
\text{Parámetros} & \text{Estimación} & \text{s.e} & \text{Valor}~ T_0 & Pr(>|t|)\\   
\hline

\phi_1 &       0.80947258 &          NA &      NA &       NA   \\ 
\phi_2 &        0.29235544 & 0.01026309 & 28.4861 &< 2.2e-16 \\
\phi_3 &        0.83574608 &        NA  &     NA   &     NA    \\
\phi_4 &       -0.97718738 &       NA   &    NA   &     NA    \\
\theta_1 &       -0.59772261 &0.06709379 & -8.9088 &4.065e-16 \\
\theta_2 &       -0.02379023 & 0.08160986 & -0.2915 &0.7709763    \\
\theta_3 &      -1.02530097 & 0.07680444 &-13.3495 &< 2.2e-16 \\
\theta_4 &        0.57191671 &   0.09730590 &   5.8775 & 1.826e-08 \\
...
\beta_0 & 35.99379105 &   1.43669891 &  25.0531 &< 2.2e-16 \\
\beta_1 &          0.12877214 &   0.02697057 & 4.7745 & 3.576e-06 \\
\beta_2 &         0.00072343 &   0.00013334 &  5.4253 & 1.739e-07 \\
\delta_1 &       -3.27798205 &   0.91813662 & -3.5703 &0.0004512 \\
\delta_2 &        5.02550149 &   0.86035968 & 5.8412 & 2.198e-08 \\
\delta_3 &       11.88902816 &   0.98219018 & 12.1046 & < 2.2e-16 \\
\delta_4 &        7.15108063 &   1.04325015 &  6.8546 & 9.605e-11 \\
\delta_5 &       11.96952023 &   1.04432641 & 11.4615 & < 2.2e-16 \\
\delta_6 &        9.77802126 &   1.04466000 & 9.3600 & < 2.2e-16 \\
\delta_7 &        8.31967279 &   1.04168471 & 7.9867 & 1.270e-13 \\
\delta_8 &        8.97756347 &   1.04341624 & 8.6040 & 2.795e-15 \\
\delta_9 &       12.52774437 &   0.97607053 & 12.8349 & < 2.2e-16 \\
\delta_{10} &       10.49509424 &   0.84641864 &  12.3994 & < 2.2e-16 \\
\delta_{11} &        8.87948093 &   0.91245714  & 9.7314 & < 2.2e-16 \\
\hline
\end{array}
$$
...
legend("topleft",legend=c("datos","ajuste modelo1"),lty=1,col= c("#717D7E", "#3498DB"))

#Gráficos de residuales
plot(residuals(modelo1), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo1$sigma2),2*sqrt(modelo1$sigma2)),lty=2, col=2)
plot(as.numeric(modelo1$fitted),residuals(modelo1), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo1$sigma2),2*sqrt(modelo1$sigma2)),lty=2, col=2)
```
...
legend("topleft",legend=c("datos","ajuste modelo2"),lty=1,col=c("#717D7E", "#3498DB"))

#Gráficos de residuales
plot(residuals(modelo2), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo2$sigma2),2*sqrt(modelo2$sigma2)),lty=2, col=2)
plot(as.numeric(modelo2$fitted),residuals(modelo2), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo2$sigma2),2*sqrt(modelo2$sigma2)),lty=2, col = 2)
```
...
qqnorm(residuals(modelo1),main="Gráfico de normalidad residuos de ajuste modelo1", col = "#01588A")
...
qqnorm(residuals(modelo2),main="Gráfico de normalidad residuos de ajuste modelo2", col= "#01588A")
...
\begin{array}{|c|c|c|c|c|}
\hline
\text{Parámetro} & \text{Estimador} & \text{s.e} & \text{Valor}~T_0 & \text{P(>|t|)}\\
\hline
\phi_1 & 0.20547223 & 0.00496340 &  41.3975 & < 2.2e-16 \\
\phi_2 & 0.22020789 & 0.00120614 & 182.5718 & < 2.2e-16 \\
\phi_3 & 0.22925007 & NA & NA & NA \\   
\phi_{11} & 0.21527156 & 0.00077845 & 276.5399 & < 2.2e-16 \\
\phi_{16} & -0.27911984 & 0.00170575 & -163.6348 & < 2.2e-16 \\
\theta_{16} & 0.00663268 & 0.00869881 &  0.7625 & 0.4466941 \\   
\theta_{17} & -0.04664808 & 0.00638427 &  -7.3067 & 6.849e-12 \\
\beta_0 & 35.75439231 & 1.78481475 &  20.0326 & < 2.2e-16 \\
\beta_1 &   0.13246994 & 0.03326014 &   3.9828 & 9.609e-05 \\
\beta_2 &  0.00070454 & 0.00016598 &  4.2446 &3.384e-05 \\
\delta_1 & -3.20813481 & 0.90705693 &  -3.5369& 0.0005059 \\
\delta_2 & 5.19447266 & 1.07886175 &   4.8148 &2.950e-06 \\
\delta_3 & 11.89802810 & 1.21480344 &   9.7942 &< 2.2e-16 \\
\delta_4 & 7.34143098 & 1.42609306 &   5.1479 &6.407e-07 \\
\delta_5 & 12.17472114 & 1.49948305 &   8.1193 &5.215e-14 \\
\delta_6 & 9.82591457 & 1.54163580 &   6.3737 &1.303e-09 \\
\delta_7 & 8.53733058 & 1.52915224 &   5.5830 &7.848e-08 \\
\delta_8 & 9.10771206 & 1.45274779 &   6.2693 &2.283e-09 \\
\delta_9 & 12.53592372 & 1.22869317 &  10.2026 &< 2.2e-16 \\
\delta_{10} & 10.67321473 & 1.07422253 &   9.9358 &< 2.2e-16 \\
\delta_{11} & 9.06327526 & 0.90126601 &  10.0562 &< 2.2e-16 \\
\hline
\end{array}
$$
...
legend("topleft",legend=c("datos","ajuste modelo3"),lty=1,col=c("#717D7E", "#3498DB"))

#Gráficos de residuales
plot(residuals(modelo3), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo3$sigma2),2*sqrt(modelo3$sigma2)),lty=2, col=2)
plot(as.numeric(modelo3$fitted),residuals(modelo3), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo3$sigma2),2*sqrt(modelo3$sigma2)),lty=2, col=2)
```
...
qqnorm(residuals(modelo3),main="Gráfico de normalidad residuos de ajuste modelo3", col = "#01588A")
...
Parámetros&Estimación&s.e&Valor~T_0&Pr(>|t|)\\
\hline
\phi_1&-0.28401500&0.08496311&-3.3428&0.0009979\\
\phi_2&0.00447891&0.09782205&0.0458&0.9635284\\
\phi_3&0.86887138&0.08435945&10.2996&<2.2e-16\\
\theta_1&0.55441161&0.11650718&4.7586&3.838e-06\\
...
\beta_0&35.69703746&2.05258297&17.3913&<2.2e-16\\
...
\delta_{2}&5.04334714&0.87227321&5.7818&2.970e-08\\
\delta_{3}&11.93369297&1.00384232&11.8880&<2.2e-16\\
\delta_{4}&7.20003327&1.05750794&6.8085&1.244e-10\\
\delta_{5}&11.95898258&1.06660554&11.2122&<2.2e-16\\
\delta_{6}&9.80840972&1.08475645&9.0420&<2.2e-16\\
\delta_{7}&8.33018717&1.06367127&7.8315&3.246e-13\\
\delta_{8}&8.96135492&1.05673368&8.4802&6.067e-15\\
\delta_{9}&12.52441180&0.99642708&12.5693&<2.2e-16\\
\delta_{10}&10.46943116&0.85849313&12.1951&<2.2e-16\\
\delta_{11}&8.85265562&0.90852259&9.7440&<2.2e-16\\
...
legend("topleft",legend=c("datos","ajuste modelo4"),lty=1,col=c("#717D7E", "#3498DB"))

#Gráficos de residuales
plot(residuals(modelo4), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo4$sigma2),2*sqrt(modelo4$sigma2)),lty=2, col=2)

plot(as.numeric(modelo4$fitted),residuals(modelo4), col = "#01588A")
abline(h=0)
abline(h=c(-2*sqrt(modelo4$sigma2),2*sqrt(modelo4$sigma2)),lty=2, col=2)
...
qqnorm(residuals(modelo4),main="Gráfico de normalidad residuos de ajuste modelo4", col= "#01588A")
...
```{r, fig.height=5, fig.width=6}
plot(ytf,lwd=2, col=1, type="b", pch=1, xlab="Periodo del año", ylab="", ylim = c(85, 120))
lines(ytpronmodelo1,lwd=2, col=2, type="b", pch=2)
lines(ytpronmodelo2,lwd=2, col=3, type="b", pch=3)
lines(ytpronmodelo3,lwd=2,col=4, type="b", pch=4)
lines(ytpronmodelo4,lwd=2,col=5, type="b", pch=5)
grid()
legend("bottomright",legend=c("Real","AR(16)", "ARMA(4,7)", "ARMA(16,17)", "ARMA(3,6)(1,1)[12]"),col=1:5,lwd=2, pch=1:5, cex=0.8)
```
...
```{r}
AIC <- c(AICmodelo1, AICmodelo2, AICmodelo4, AICmodelo3)
BIC <- c(BICmodelo1, BICmodelo2, BICmodelo4, BICmodelo3)
modelo <- c("Modelo 1", "Modelo 2", "Modelo 3", "Modelo 4")

data_ajuste <- cbind(modelo, AIC = round(AIC,3), BIC = round(BIC,3))
data_ajuste
```
...
Modelo&AIC&BIC\\   
\hline
Modelo~1 &11.266 &18.003\\
Modelo~2 &10.953 &16.188\\
Modelo~3 &11.252 &16.631\\
Modelo~4 &11.246 &15.614\\
\hline
\end{array}
$$
