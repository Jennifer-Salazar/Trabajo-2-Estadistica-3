...
```{r, fig.height=5, fig.width=6}
plot(residuals(mod1), type = "l", xlab = 'Tiempo', ylab = 'Residuales', col = '#01588A', lwd = 1)
abline(h=c(-2*summary(mod1)$sigma, 0, 2*summary(mod1)$sigma), col=2)
abline(h = 0, col=2)
grid()

plot(as.numeric(mod1$fitted),residuals(mod1), col = "#01588A")
abline(h=0)
...
grid()
legend("topleft",legend=c("Origina","Ajuste modelo 1"),lty=1,col= c("#717D7E", "#3498DB"))
...
modelo&p&AIC&BIC\\
\hline
Modelo~global&14&16.85948&20.98234\\
Modelo~1&30&11.26579&18.00337\\
Modelo~2&25&10.95304&16.18807\\
Modelo~3&25&11.25246&16.63059\\
Modelo~4&21&11.24595&15.61388\\
\hline
\end{array}
$$
